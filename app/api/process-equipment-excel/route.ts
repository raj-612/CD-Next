...
import { EQUIPMENT_SCHEMA } from './schema';
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      ...
      message: 'Equipment and resources data processed successfully'
    });
    
  } catch (error: any) {
    console.error('Error processing equipment and resources data:', error);
    return NextResponse.json(
